<template>
  <section class="bl-services1">
    <div class="ln-container">
      <h2 class="ln-base-title-lg-bold">Услуги</h2>

      <div class="bl-services1-slider" v-if="dataServices.length > 0">
        <agile
          :nav-buttons="false"
          :dots="false"
          ref="service1slider"
          ...
          :infinite="infinite"
          :options="{responsive:[{breakpoint: 992,settings: {slidesToShow: 3}},{breakpoint: 768,settings: {slidesToShow: 2}}, {breakpoint: 500,settings: {slidesToShow: 1}}]}"
          >

          <div class="bl-services1-slide" v-for="service in dataServices">
            <div
              class="bl-services1-item"
              :style="{'background-image':'url(' + service.fm_image + ')'}"
              >
              <div class="bl-services1-body">
                <h3 class="bl-services1-title">{{ service.name }}</h3>
                <div class="bl-services1-subtitle" v-html="service.short_description"></div>
                <div class="bl-services1-area">
                  <div class="bl-services1-text" v-bar>
                    <div v-if="service.description" v-html="service.description"></div>
                    <div v-else v-html="service.short_description"></div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="bl-services1-footer" v-if="slidesToShow >= 3">
        <div class="bl-services1-nav">
          <div class="bl-services1-btn" @click="$refs.service1slider.goToPrev();">
          ...
          <div class="bl-services1-btn" @click="$refs.service1slider.goToNext();">
            <svg width="14" height="12" viewBox="0 0 14 12" fill="none" xmlns="http://www.w3.org/2000/svg">
