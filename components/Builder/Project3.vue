<template>
  <section class="bl-project2">
    <div class="bl-project2-wrap"  v-if="dataElements.length > 0">
          <div class="bl-project2-slide">
            <div class="bl-project2-info">
              <agile
                :nav-buttons="false"
                :dots="false"
                ref="blproject2info"
                ...
                <div class="slide" v-if="project.is_show">
                  <div class="bl-project2-info-block">
                    ...
                    <h3 class="bl-project2-title">
                        <a :href="'/project/'+ project.id">{{ project.name }}</a>
                    </h3>
                    <div class="bl-project2-area">
                      <div class="bl-project2-text"  v-bar>
                        <div>
                          <div class="bl-project2-scroll"  v-html="project.description"></div>
                        </div>
                      </div>
                    </div>
                    <div class="bl-project2-str"><a :href="'/project/'+ project.id">{{ project.str_property }}</a></div>
                    <a :href="'/project/'+ project.id" class="bl-project2-link">смотреть проект</a>
                  </div>
                </div>
              </template>
              </agile>
      ...
      <div class="bl-project2-nav">
        <div class="bl-project2-btn" @click="$refs.blproject2info.goToPrev();$refs.blproject2image.goToPrev()">
        ...
        <div class="bl-project2-btn" @click="$refs.blproject2info.goToNext();$refs.blproject2image.goToNext()">
          <svg width="14" height="12" viewBox="0 0 14 12" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="bl-project2-footer"  v-if="dataElements.length > 0">
